...
## Práctica de Introducción a los Estudios de Asociación Genómica.
En la carpeta [Secuencias_NGS](https://github.com/GenomicsEducation/JaquelineFlores/tree/main/Secuencias_NGS) podrás encuentrar la carpeta [Asociación Genómica](https://github.com/GenomicsEducation/JaquelineFlores/tree/main/Secuencias_NGS/Asociaci%C3%B3n%20Gen%C3%B3mica), que contiene el archivo [Práctica de Asociación Genómica.md](https://github.com/GenomicsEducation/JaquelineFlores/blob/main/Secuencias_NGS/Asociaci%C3%B3n%20Gen%C3%B3mica/Pr%C3%A1ctica%20de%20Asociaci%C3%B3n%20Gen%C3%B3mica.md), mismo que contiene un resumen de una práctica en Rstudio para un análisis de asociación genómica, en la misma carpeta podrás encontrar un script con anotaciones, para cargar en Rstudio, y los archivos empleados en la práctica.  
