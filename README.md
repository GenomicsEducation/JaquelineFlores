...
_Notas: Asegurate de que toda la información que le sigue a `wget` quede como una sola línea, tal como se muestra en la imagen, ya que si no aparecera un error al correr el archivo. También asegurate de guardar los cambios utilizando `ctrl + o`, para salir del documento utiliza `ctrl + x`._  
